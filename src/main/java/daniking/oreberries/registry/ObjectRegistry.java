...
public final class ObjectRegistry {
    ...
    // Nuggets
    public static final Item COPPER_NUGGET = create("copper_nugget", new NuggetItem(getItemSettings(), CONFIG_FILE.copper.ingotColor));
    public static final Item TIN_NUGGET = create("tin_nugget", new NuggetItem(getItemSettings(), CONFIG_FILE.tin.ingotColor));
    public static final Item ALUMINUM_NUGGET = create("aluminum_nugget", new NuggetItem(getItemSettings(), CONFIG_FILE.aluminum.ingotColor));

    // OreBerries
    public static final Block IRON_OREBERRY_BUSH = create("iron_oreberry_bush", new OreBerryBushBlock(getBushBlockSettings(), CONFIG_FILE.iron.oreBerryColor, OBHelper.OreBerryType.IRON));
    ...
    public static final Block GOLD_OREBERRY_BUSH = create("gold_oreberry_bush", new OreBerryBushBlock(getBushBlockSettings(), CONFIG_FILE.gold.oreBerryColor, OBHelper.OreBerryType.GOLD));
    ...
    public static final Block COPPER_OREBERRY_BUSH = create("copper_oreberry_bush", new OreBerryBushBlock(getBushBlockSettings(), CONFIG_FILE.copper.oreBerryColor, OBHelper.OreBerryType.COPPER));
    ...
    public static final Block TIN_OREBERRY_BUSH = create("tin_oreberry_bush", new OreBerryBushBlock(getBushBlockSettings(), CONFIG_FILE.tin.oreBerryColor, OBHelper.OreBerryType.TIN));
